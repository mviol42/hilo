# Task 1.8a: Skill for Unit Testing (Red-Green-Refactor)

## Objective

Create a Claude Code skill that teaches the red-green-refactor TDD workflow for this project.
...
- Skill is model-invoked: Claude automatically uses it when context matches
- Located in project `.claude/skills/` so it's shared via git
- Focused specifically on backend unit testing (separate from integration tests)
