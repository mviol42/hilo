# Task 1.8b: Skill for Integration Testing

## Objective

Create a Claude Code skill for running integration tests that verify HTTP API and WebSocket behavior.
...
- Distinct from unit testing skill - focuses on API/WebSocket integration
